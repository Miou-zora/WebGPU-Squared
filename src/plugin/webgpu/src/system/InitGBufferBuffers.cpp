...
void InitGBufferBuffers(ES::Engine::Core &core) {
    ...
    Uniforms uniforms; uniforms.modelMatrix = glm::mat4(1.0f); uniforms.normalModelMatrix = glm::mat4(1.0f);
    ...
    Camera camera; camera.viewProjectionMatrix = glm::mat4(1.0f); camera.invViewProjectionMatrix = glm::mat4(1.0f);
